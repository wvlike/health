...
public class MessageConstant {
    ...
    public static final String GET_IMAGE_ADDRESS_FAIL= "获取的图片地址不存在";
    ...
    public static final String DELETE_MENU_EXIST = "当前菜单被引用，不能删除";
    ...
    public static final String DELETE_PERMISSION_EXIST = "当前权限被引用，不能删除";
    ...
    public static final String DELETE_ROLE_EXIST = "当前角色被引用，不能删除";
    ...
    public static final String QUERY_ROLEIDS_SUCCESS = "查询角色ID列表成功";
    public static final String QUERY_ROLEIDS_FAIL = "查询角色ID列表成功";
